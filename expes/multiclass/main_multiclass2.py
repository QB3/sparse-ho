...
from sparse_ho.ho_dirty import grad_search, adam_search, grad_search_backtrack_dirty, grad_search_backtracking_cd_dirty2
# , lbfgs
from sparse_ho.ho import grad_search_wolfe_cd_dirty
from sparse_ho.utils import Monitor
from sparse_ho.utils_datasets import get_alpha_max
...
estimator = LogisticRegression(
    C=1, fit_intercept=False, warm_start=True, max_iter=500, verbose=False)
...
# # log_alpha0 = monitor_grid.log_alphas[-1]
# adam_search(
