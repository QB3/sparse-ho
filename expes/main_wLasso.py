...
# from sparse_ho.lasso import Monitor, grid_searchCV, line_search, WarmStart
...
#                 'log_alpha0': np.log(rho * alpha_max), 'tol': tol,
#                 'n_outer': n_outer, 'monitor': monitor,
#                 'method': "implicit_forward", 'niter_jac': 500,
...
#                 'monitor': monitor, 'method': "implicit",
#                 'niter_jac': 500, 'warm_start': warm_start,
#                 'model': "lasso", 'sigma': sigma_star,
...
#                 'maxit': 1000, 'max_evals': n_outer,
#                 'method': "bayesian", 'sigma': sigma_star,
#                 'criterion': "sure", 'beta_star': beta_star}
#         elif method == "random":
#             func = grid_searchCV
#             kwargs = {
#                 'X': X, 'y': y, 'X_val': None, 'y_val': None,
#                 'X_test': None, 'y_test': None,
#                 'log_alphas': log_alphas, 'tol': tol,
#                 'monitor': monitor, 'sk': False, 'sigma': sigma_star,
#                 'criterion': "sure", 'beta_star': beta_star,
#                 'random': True, 'max_evals': 100}
#     elif model == "alasso":
#         log_alpha, _, _ = line_search(
#             X, y, np.ones(n_features) * np.log(rho * alpha_max), None, None,
#             None, None, tol=tol, monitor=monitor, method="implicit_forward",
#             n_outer=n_outer, warm_start=warm_start, niter_jac=500,
...
#             kwargs = {
#                 'X_train': X, 'y_train': y, 'X_val': None, 'y_val': None,
#                 'X_test': None, 'y_test': None, 'log_alpha0': np.ones
#                 (n_features) * np.log(rho * alpha_max),
#                 'tol': tol, 'n_outer': n_outer,
#                 'monitor': monitor, 'method': "implicit_forward",
#                 'niter_jac': 500, 'warm_start': warm_start, 'model':
#                 "alasso", 'sigma': sigma_star,
...
#                 'X_train': X, 'y_train': y, 'X_val': None, 'y_val': None,
#                 'X_test': None, 'y_test': None,
#                 'log_alpha0': np.ones(n_features) * np.log(rho * alpha_max),
#                 'tol': tol, 'n_outer': n_outer,
#                 'monitor': monitor, 'method': "implicit", 'niter_jac': 500,
#                 'warm_start': warm_start, 'model': "alasso",
#                 'sigma': sigma_star, 'criterion': "sure",
#                 'beta_star': beta_star, 't_max': 500}
#         elif method == "forward":
#             func = line_search
#             kwargs = {
#                 'X_train': X, 'y_train': y, 'X_val': None, 'y_val': None,
...
#     return (
#         model, method, n_samples, n_features, SNR, n_active, rho,
#         p_alpha_min, p_alpha_opt, alpha_max, monitor.times[-1], seed, *metrics,
#         monitor.rmse)
...
#         n_pts_roc, seed, tol, n_outer)
#     for model, method, nfeatures, seed in product(
#         models, methods, list_n_features, list_seed))
