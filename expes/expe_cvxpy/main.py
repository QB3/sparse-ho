...
dict_ncols[100] = np.geomspace(100, n_features//4, num=10, dtype=int)
...
def parallel_function(name_model, div_alpha):
    ...
    np.save("results/times_%s_forward_%s" % (name_model, div_alpha), list_times_fwd)
    np.save("results/times_%s_backward_%s" % (name_model, div_alpha), list_times_bwd)
    np.save("results/times_%s_cvxpy_%s" % (name_model, div_alpha), list_times_cvxpy)
    np.save("results/nfeatures_%s_%s" % (name_model, div_alpha), list_nfeatures)
