...
# X, y = make_regression(
#     n_samples=3000, n_features=10000)
...
algo = ImplicitForward(criterion, use_sk=True, n_iter_jac=100)
monitor_wolfe = Monitor()
grad_search_wolfe(
    algo, np.log(alpha_max/10), monitor_wolfe, n_outer=50, tol=tol, maxit_ln=5)
t_gradsearch = time.time() - t0
