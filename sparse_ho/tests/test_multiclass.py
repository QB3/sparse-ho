...
estimator = LogisticRegression(
    solver='liblinear', penalty='l1', max_iter=max_iter,
...
n_alphas = 10
p_alphas = np.geomspace(1, 0.01, n_alphas)
...
for i in range(n_alphas):
    ...
    lr = LogisticRegression(
        solver='liblinear', multi_class='ovr', penalty='l1', max_iter=max_iter,
        random_state=42, fit_intercept=False, warm_start=True,
        C=1 / (alpha_max * p_alphas[0, i] * len(idx_train)), tol=tol)
