...
def _grad_search(
    ...
    Parameters
    --------------
    _get_val_grad: function
        used to obtain the current value of the outer objective value and
        its respective gradient.
    proj_hyperparam: function
        used to project the current hyperparameter iterate on its living
        subspace.
    log_alpha0: float
        log of the regularization coefficient alpha.
    monitor: Monitor object
